document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const questionElement = document.querySelector(".content #question");
    questionElement.innerHTML = question.text;

    // 2. Update the green progress bar
    // Update the green progress bar (div#progressBar) width so that it shows the percentage of questions answered
    const progessBarElement = document.querySelector("#progressBar");
    console.log(quiz.currentQuestionIndex + 1, quiz.questions.length);
    progessBarElement.style.width = `${
    ...
    question.choices.forEach((choice) => {
      ...
      choiceContainer.append(li);

      // const choicesForEach = `<input type="radio" name="choice" value=${choice}>
      //     <label>${choice}</label>`;
      // choiceContainer.innerHTML += choicesForEach;
    });
